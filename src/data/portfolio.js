export default [
    {
        title: "A* Pathfinding",
        imgURL: "assets/pathfinding.png",
        stack: ["Java", "Swing"],
        description: [
            "● Implemented the A* Pathfinding Algorithm in Java to find shortest path between two points on a grid-based map.",
            "● Used object-oriented principles to create classes for the map, the nodes, and the pathfinding algorithm, Java Swing was used to create a user-friendly interface that allowed users to interact with the map and visualize the pathfinding algorithm in real-time.",
        ],
        link: "https://github.com/BradleyBeamish/A-Star-Pathfinding",
    },
    {
        title: "Online Store",
